...
@EnableJpaRepositories(
        ...
        basePackages= { "org.springboot.sharding.jdbc3.multiple.repository.datasource2" }) //设置Repository所在位置
public class Test2DataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactorySecondary (EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("org.springboot.sharding.jdbc3.multiple.entity.datasource2") //设置实体类所在位置
