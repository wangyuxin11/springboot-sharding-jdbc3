package org.springboot.sharding.jdbc3.mybaits.jta.datasource;
...
@Configuration
@MapperScan(basePackages = "org.springboot.sharding.jdbc3.mybaits.jta.mapper.test02", sqlSessionTemplateRef = "test2SqlSessionTemplate")
