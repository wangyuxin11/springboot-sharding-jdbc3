package org.springboot.sharding.jdbc3.controller;

import java.util.ArrayList;
import java.util.List;

import org.springboot.sharding.jdbc3.entity.Goods;
import org.springboot.sharding.jdbc3.repository.GoodsRepository;
...
启动应用，在浏览器或HTTP请求工具访问http://localhost:8090/save，如图所示，返回success。

接下来在测试一下查询方法，访问http://localhost:8090/select，如图所示，可以看到插入数据没问题。
